(function () {
  ...
  var PRODUCTS = [
    {
      ...
      ingredients: 'Nước, sợi yến, đường phèn, chất làm dày (INS 401, INS 327), chất ổn định (INS 406, INS 415), taurine, lysine, vitamin D3, hương cam tổng hợp.',
      uses: [
        'Tăng cường sức khỏe và đề kháng: Sợi yến tươi giàu protein và axit amin thiết yếu, giúp tăng cường hệ miễn dịch. Taurine hỗ trợ chức năng miễn dịch và bảo vệ tế bào.',
    ...
    },
    {
      ...
      ingredients: 'Nước, sợi yến, đường phèn (8.5%), chất làm dày (INS 401, INS 327), chất ổn định (INS 406, INS 415), hương yến tổng hợp.',
      uses: [
        'Tăng cường sức khỏe và đề kháng: Sợi yến tươi giàu protein, axit amin và khoáng chất thiết yếu, giúp tăng cường hệ miễn dịch.',
    ...
    },
    {
      ...
      ingredients: 'Nước, sợi yến, đường phèn, nhụy hoa nghệ tây saffron (2%), chất làm dày (INS 401, INS 327), chất ổn định (INS 406, INS 415), phẩm màu tổng hợp (INS 102), hương yến tổng hợp.',
      uses: [
    ...
    },
    {
      ...
      ingredients: 'Nước, sợi yến, đường phèn, đông trùng hạ thảo (2%), chất làm dày (INS 401, INS 327), chất ổn định (INS 406, INS 415), hương yến tổng hợp.',
      uses: [
    ...
    },
    {
      ...
      ingredients: 'Nước, sợi yến, đường phèn, táo đỏ (2%), chất làm dày (INS 401, INS 327), chất ổn định (INS 406, INS 415), hương yến tổng hợp.',
      uses: [
    ...
    },
    {
      ...
      ingredients: 'Nước, sợi yến, đường phèn, kỷ tử (2%), chất làm dày (INS 401, INS 327), chất ổn định (INS 406, INS 415), hương yến tổng hợp.',
      uses: [
    ...
    },
    {
      ...
      ingredients: 'Nước, sợi yến, đường phèn, collagen (2%), chất làm dày (INS 401, INS 327), chất ổn định (INS 406, INS 415), hương yến tổng hợp.',
      uses: [
    ...
    },
    {
      ...
      price: '89.000đ/hũ',
      tiers: TIER_NOTE,
      desc: 'Sản phẩm kết hợp giữa tổ yến và 4 loại thảo quả: táo đỏ, kỷ tử, long nhãn, hạt chia mang lại nhiều công dụng cho sức khỏe tổng thể và sắc đẹp. Phù hợp sử dụng trong gia đình hay làm quà tặng biếu.',
      ingredients: 'Nước, sợi yến, đường phèn, táo đỏ (2%), long nhãn (2%), hạt chia (2%), kỷ tử (2%), chất làm dày (INS 327, INS 401, INS 406), chất ổn định (INS 415, INS 406), hương yến tổng hợp.',
      uses: [
  ...
  // ---------- Additional static carousels, same look as the flavor carousel above
  // (Bộ Quà Tặng / Yến Tổ) — no detail modal, just prev/next + dots ----------
  document.querySelectorAll('[data-carousel-track]').forEach(function (carTrack) {
    var carViewport = carTrack;
    var wrap = carTrack.closest('.jar-carousel__viewport');
    var carPrev = wrap.querySelector('[data-carousel-prev]');
    var carNext = wrap.querySelector('[data-carousel-next]');
    var carDots = wrap.parentElement.querySelector('[data-carousel-dots]');
    var carCards = Array.prototype.slice.call(carTrack.children);

    carCards.forEach(function (_, i) {
      var dot = document.createElement('button');
      dot.type = 'button';
      dot.setAttribute('aria-label', 'Xem sản phẩm ' + (i + 1));
      dot.addEventListener('click', function () { scrollToCard(i); });
    ...
    var carDotEls = Array.prototype.slice.call(carDots.children);

    function step() {
      return carCards[0] ? carCards[0].getBoundingClientRect().width + 22.4 : 260;
    }
    function scrollToCard(i) {
      carViewport.scrollTo({ left: step() * i, behavior: 'smooth' });
    }
    function updateActiveDot() {
      var i = Math.round(carViewport.scrollLeft / step());
      carDotEls.forEach(function (d, idx) { d.classList.toggle('is-active', idx === i); });
    }
    carViewport.addEventListener('scroll', function () {
      window.requestAnimationFrame(updateActiveDot);
    }, { passive: true });

    if (carPrev) {
      carPrev.addEventListener('click', function () {
        carViewport.scrollBy({ left: -step() * 2, behavior: 'smooth' });
      });
    }
    if (carNext) {
