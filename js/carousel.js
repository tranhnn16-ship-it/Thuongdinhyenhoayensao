(function () {
  ...
  var PRODUCTS = [
    ...
    },
    {
      id: 'an-kieng',
      badge: '40% Sợi Yến',
      name: 'Tổ Yến Chưng Đường Ăn Kiêng',
      img: 'assets/images/jar-anKieng.webp',
      price: '89.000đ/hũ',
      tiers: TIER_NOTE,
      desc: 'Sản phẩm dinh dưỡng cao cấp được thiết kế đặc biệt dành cho những người cần kiểm soát lượng đường trong chế độ ăn uống. Lựa chọn lý tưởng cho những người vừa muốn bồi bổ sức khỏe, vừa cần kiểm soát lượng đường nạp vào cơ thể.',
      ingredients: 'Nước, sợi yến (40%), đường Isomalt (6.5%), chất làm dày (INS 401, INS 327), chất ổn định (INS 406, INS 415), hương yến tổng hợp.',
      uses: [
        'Phù hợp cho người ăn kiêng và kiểm soát đường huyết.',
        'Tăng cường sức khỏe và đề kháng: 40% sợi yến tươi giàu protein, axit amin và khoáng chất thiết yếu.',
        'Hỗ trợ làm đẹp và chống lão hóa: đường Isomalt không gây tổn hại đến cấu trúc collagen của cơ thể, giữ cho làn da khỏe mạnh.',
        'Hỗ trợ năng lượng nhẹ nhàng: đường Isomalt cung cấp năng lượng ổn định, giảm mệt mỏi mà không gây tăng đột biến đường huyết.'
      ],
      usage: [
        'Đối tượng sử dụng: người lớn, trẻ em từ 1 tuổi trở lên, phụ nữ mang thai (4 tháng trở lên) và người cao tuổi.',
        'Khuyến nghị dùng 1 hũ/ngày.',
